...
let buildSubMenus = () => {
    ...
    for ( let i = 0; i < menuItems.length; i++ ) {
        ...
        // for (const obj1 in menuItems[i]) {
        //     const s1 = document.createElement('a');
        //     s1.textContent = menuItems[i][ctr].text;
        //     s1.setAttribute('href', menuItems[i][ctr].href);
        //     subMenu1.append(s1)
        //     ctr++
        // }
        // for (let j = 0; j < row.length; j++ ) {
...
// subMenu1.classList.add( 'whichSpace', 'a' );

let subMenu2 = document.querySelector( 'subMenu2' );

let menuLinks = loadMenu();
let subLinks1 = buildSubMenus( mainMenu );
